            ...
            <div className="lg:col-span-2">
              ...
              {step === 4 && orderResult && (
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="py-8">
                  {/* Header - Using Clock icon, NOT checkmark */}
                  <div className="text-center mb-8">
                    <div className="w-20 h-20 bg-orange-100 border-4 border-orange-400 rounded-full flex items-center justify-center mx-auto mb-6">
                      <Clock className="w-10 h-10 text-orange-600" />
                    </div>
                    <h2 className="text-3xl font-bold uppercase tracking-tight mb-2" data-testid="order-success-title">
                      Order Received
                    </h2>
                    <p className="text-neutral-600 text-lg">Your order has been received and is awaiting payment confirmation.</p>
                  </div>

                  {/* Order Details Card */}
                  <div className="bg-white border-2 border-neutral-200 rounded-lg overflow-hidden mb-6">
                    {/* Status Banner - Orange for Awaiting */}
                    <div className="bg-orange-500 text-white p-4 text-center">
                      <p className="font-bold text-lg uppercase tracking-wide">⏳ AWAITING PAYMENT</p>
                      <p className="text-orange-100 text-sm mt-1">Payment Method: Bank Transfer</p>
                    </div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 mb-6">
                        <div className="bg-neutral-100 p-4 rounded-lg text-center">
                          <p className="text-sm text-neutral-500 uppercase tracking-wide mb-1">Order Number</p>
                      ...
                      <div className="bg-green-50 border border-green-300 rounded-lg p-5 mb-6">
                        <h4 className="font-bold text-green-800 mb-3 text-lg">📤 Send Payment Proof</h4>
                        <p className="text-green-700 mb-4">
                          Please send your payment receipt/proof via WhatsApp for faster verification. Your order will be confirmed once payment is verified.
                        </p>
                        <a 
                          href={`https://wa.me/2349057449212?text=Hi,%20I%20just%20made%20a%20payment%20for%20order%20${orderResult.reference}.%20Amount:%20${orderResult.total}.%20Please%20verify%20my%20payment.`}
                          target="_blank"
                      ...
                      <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-4">
                        ...
                        <ol className="text-sm text-yellow-700 space-y-2 list-decimal list-inside">
                          ...
                          <li>Send your payment receipt via WhatsApp for verification</li>
                  ...
                  <div className="bg-neutral-100 rounded-lg p-6 text-center mb-6">
                    ...
                    <p className="text-sm text-neutral-500">Order Number: <span className="font-mono font-bold">{orderResult.reference}</span></p>
                  </div>
